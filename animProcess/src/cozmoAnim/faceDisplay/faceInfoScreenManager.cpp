...
const std::string OSProject = "redOS";
const std::string Creator = "By ekeleze";
const std::string CreatorWebsite = "ekeleze.net";
...
void FaceInfoScreenManager::Init(Anim::AnimContext* context, Anim::AnimationStreamer* animStreamer)
{
  ...
  ADD_SCREEN_WITH_TEXT(ClearUserData, Main, {"RESET?"});
  ADD_SCREEN_WITH_TEXT(ClearUserDataFail, Main, {"UNABLE TO RESET"});
  ADD_SCREEN_WITH_TEXT(Rebooting, Rebooting, {"RESETIING..."});
